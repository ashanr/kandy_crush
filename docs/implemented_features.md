...
- **"සීනි කැට රාජධානිය" (Sugar Gem Kingdom) Theme**: Main home page title localized to **👑 සීනි කැට රාජධානිය** in 3D candy text shadow with an animated golden crown badge and frosted glass banner featuring a glowing golden bottom border (`border-bottom: 2.5px solid rgba(255, 215, 0, 0.55)`).
...
- **Pulsing Royal Play Button**: Bottom `"ගේම් එක පටන් ගන්න"` button features a 3D Royal Gold & Magenta bar with a crown badge, spinning sparkle icon, and shimmering light sweep animations.
